...
begin
  ...
  k := 0;
  i := 1;
  while (day + mth[i]) mod 7 <> 0 do    {все пурга, давай по-новой}
  begin                                 {нужно найти 13е число и его день недели}
    inc(i);
  end;
  month := i;
...
begin
  if (Edit1.Text <> '') then
  begin
//    Label1.Caption := '¬ 20м веке ' + IntToStr(black_friday_count(20)) + ' п€тницы';
    Label2.Caption := '¬ ' + Edit1.Text + 'м веке ' + IntToStr(black_friday_count(StrToInt(Edit1.Text))) + ' п€тницы';
